...
export type UseSiteMetaDataQuery = { site?: { siteMetadata?: { title?: string | null, description?: string | null } | null } | null };

export type CategoriesQueryVariables = Exact<{ [key: string]: never; }>;


export type CategoriesQuery = { allMdx: { group: Array<{ fieldValue?: string | null, totalCount: number }> } };
...
export type BlogPostQuery = { mdx?: { frontmatter?: { title?: string | null, date?: any | null } | null } | null };

export type CategoriesItemQueryVariables = Exact<{
  category?: InputMaybe<Scalars['String']>;
}>;


export type CategoriesItemQuery = { allMdx: { totalCount: number, edges: Array<{ node: { id: string, frontmatter?: { title?: string | null, slug?: string | null } | null } }> } };
